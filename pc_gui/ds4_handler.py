    ...
    def _refresh_devices(self):
        ...
        for i in range(count):
            try:
                ...
                # --- DIAGNOSTIC ---
                # Print all information about the found joystick to help the user identify it.
                name = joystick.get_name()
                guid = joystick.get_guid()
                print(f"INFO: Found Joystick {i}: Name='{name}', GUID='{guid}'")
                # --- END DIAGNOSTIC ---

                self.joysticks.append(joystick) # Store the object
                gamepads_info.append({'name': name, 'index': i})
            except pygame.error as e:
