...
// Switch Device Descriptor (as Pro Controller)
tusb_desc_device_t const desc_device = {
    ...
    .idVendor = 0x057E, .idProduct = 0x2009, .bcdDevice = 0x0100,
...
//--------------------------------------------------------------------+
#if CFG_TUD_HID_NINTENDO
// Switch Pro Controller HID Descriptor
...
#elif CFG_TUD_HID_SONY
// DS4 report descriptor from passinglink project
...
uint8_t const desc_configuration[] = {
  ...
  TUD_HID_INOUT_DESCRIPTOR(0, 0, HID_ITF_PROTOCOL_NONE, sizeof(ds4_report_descriptor), EPNUM_HID_IN, EPNUM_HID_OUT, CFG_TUD_HID_EP_BUFSIZE, 4)
};
#else
